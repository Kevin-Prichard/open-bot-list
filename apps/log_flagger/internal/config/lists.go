...
var IPLIST_FLAGS = map[string][]string{
	...
	"src_net_crawler_mon_betterstack":   {"bot", "bot_crawler", "org_betterstack"},
	"src_net_crawler_mon_catchpoint":    {"bot", "bot_crawler", "org_catchpoint"},
	"src_net_crawler_mon_qualys":        {"bot", "bot_crawler", "org_qualys"},
	"src_net_crawler_mon_solarwinds":    {"bot", "bot_crawler", "org_solarwinds"},
	"src_net_crawler_mon_uptimerobot":   {"bot", "bot_crawler", "org_uptimerobot"},
	"src_net_crawler_mon_statuscake":    {"bot", "bot_crawler", "org_trafficcake"},
